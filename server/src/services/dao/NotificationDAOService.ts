...
export default class NotificationDAOService implements ICrudDAO<INotificationModel> {
  ...
  findByIdPopulatePermissions(id: any, options?: QueryOptions): Promise<INotificationModel | null> {
    return this.notificationRepository.findByIdPopulatePermissions(id, options);
  }

  findByAnyPopulatePermissions(filter: FilterQuery<INotificationModel>, options?: QueryOptions): Promise<INotificationModel | null> {
