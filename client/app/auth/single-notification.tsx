import { ActivityIndicator, Dimensions, Image, Platform, RefreshControl, TouchableOpacity } from "react-native";
...
import { getSingleNotificationAction, updateNotificationAction } from "../../store/actions/userAction";
import { useEffect } from "react";
import settings from "../../config/settings";
import { BlurView } from "expo-blur";
import AppBtn from "../../components/common/button/AppBtn";
import { clearGetSingleNotificationStatus, clearUpdateNotificationStatus, setFromUserId } from "../../store/reducers/userReducer";
...
export default function SingleNotification() {
    ...
    useEffect(() => {
        dispatch(getSingleNotificationAction({notificationId: notificationId}))
    },[notificationId]);
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <ScrollView
                ...
                onRefresh={() => dispatch(getSingleNotificationAction({notificationId: notificationId}))}/>}
            >
                <>
                {renderHeader()}
                <View
