...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/five` | `/five` | `/(tabs)/four` | `/four` | `/(tabs)/one` | `/one` | `/(tabs)/three` | `/three` | `/(tabs)/two` | `/two` | `/auth/about` | `/auth/billing` | `/auth/edit-user-detail` | `/auth/favourites` | `/auth/gallery` | `/auth/gender` | `/auth/interests` | `/auth/modals/chatMessageScreen` | `/auth/modals/job-description` | `/auth/modals/match` | `/auth/modals/partnerPreference` | `/auth/modals/planScreen` | `/auth/notification` | `/auth/notifications` | `/auth/privacy-security` | `/auth/profile-detail` | `/auth/single-notification` | `/auth/single-user` | `/modal` | `/unauth/create-account` | `/unauth/login` | `/unauth/sign-up` | `/unauth/token-page` | `/unauth/verification`;
  // prettier-ignore
